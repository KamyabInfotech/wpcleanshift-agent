...
## [1.0.0-rc.428] — 2026-09-15

### Chore
- Sync packaging VERSION to monorepo tip 1.0.0-rc.428 (marketing Protect-after-connect honesty).
...
- README honesty: operator-approved remediation (not silent auto-clean); monorepo is source of truth for signed packages.
